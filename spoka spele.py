...
def foyer():
    print("Tu ieej foajē. Ir tumšs, bet redzi durvis uz 'virtuvi' un 'dzīvojamo istabu' vai 'pagrabu'.")
    choice = ""
...
def living_room():
    print("Dzīvojamā istaba ir putekļaina un tajā ir dīvains spogulis.Blakus tam ir atslēga. Vai tu vēlies 'skatīties' spogulī, 'paņemt' atslēgu vai iet 'atpakaļ'?")
    choice = ""
    while choice not in ["skatīties", "atpakaļ"]:
        ...
        print("Tu paņēmi atslēgu! Tā noderēs pagrabam")
        while choice == "atpakaļ":
            foyer()
    else:
        print("Nepareiza izvēle.")
